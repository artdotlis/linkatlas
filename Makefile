...
runLock runUpdate: %: export_%
	...
	$(UVE) export --package utilslink --frozen --format requirements.txt > packages/utilslink/requirements.txt
	$(UVE) export --package taxalink --frozen --format requirements.txt > packages/taxalink/requirements.txt
	$(UVE) export --package publink --frozen --format requirements.txt > packages/publink/requirements.txt
	$(UVE) export --package catlink --frozen --format requirements.txt > packages/catlink/requirements.txt
	$(UVE) export --package seqlink --frozen --format requirements.txt > packages/seqlink/requirements.txt
	$(UVE) export --package bdlink --frozen --format requirements.txt > packages/bdlink/requirements.txt
	$(UVE) export --package silink --frozen --format requirements.txt > packages/silink/requirements.txt
